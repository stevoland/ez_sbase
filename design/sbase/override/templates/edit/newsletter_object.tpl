...
{include uri='design:eznewsletter/edit_newsletter_object.tpl' objectID=$object.id objectVersion=$edit_version}
...
{* include uri='design:eznewsletter/edit_newsletter_recurrence.tpl' objectID=$object.id objectVersion=$edit_version *}
